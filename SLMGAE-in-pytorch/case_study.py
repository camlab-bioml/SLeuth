...
def get_case_study_pairs(gene_to_idx):
    """Define case study gene pairs (Entrez Gene IDs)"""
    case_study_pairs = [
        # Well-known synthetic lethal pairs (Entrez IDs)
        ("672", "142"),  # BRCA1-PARP1
        ("675", "142"),  # BRCA2-PARP1
        ("7157", "4193"),  # TP53-MDM2
        ("3845", "65975"),  # KRAS-STK33
        ("7428", "3091"),  # VHL-HIF1A
        ("8289", "57492"),  # ARID1A-ARID1B
        ("6597", "6595"),  # SMARCA4-SMARCA2
        ("5925", "1869"),  # RB1-E2F1
        ("5728", "5290"),  # PTEN-PIK3CA
        ("4609", "1025"),  # MYC-CDK9
    ]
