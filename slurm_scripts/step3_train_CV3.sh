...
mkdir -p ../logs
mkdir -p ../outputs/CV3
mkdir -p ../outputs/CV3/checkpoints
mkdir -p ../outputs/CV3/predictions
...
for fold in 0 1 2 3 4; do
	PRED_FILE="../outputs/CV3/fold_${fold}_cv3_predictions.csv"
	if [ -f "$PRED_FILE" ]; then
...
echo "Results saved to: ../outputs/CV3/"
echo "=================================================="
