#!/bin/bash
#SBATCH --job-name=SLMGAE_main_ESM
...
mkdir -p ../logs
mkdir -p ../outputs/main_with_ESM
mkdir -p ../outputs/main_with_ESM/checkpoints
mkdir -p ../outputs/main_with_ESM/predictions
...
echo "  - Output dir: ../outputs/main_with_ESM"
...
$PYTHON_PATH train_slmgae_with_esm.py \
	...
	--pos_neg_ratio 1 \
	--seed 123 \
	--output_dir ../outputs/main_with_ESM
...
for fold in 0 1 2 3 4; do
	PRED_FILE="../outputs/main_with_ESM/fold_${fold}_cv1_predictions.csv"
	if [ -f "$PRED_FILE" ]; then
...
echo "All 6375x6375 prediction matrices saved in: ../outputs/main_with_ESM/"
echo "=================================================="
