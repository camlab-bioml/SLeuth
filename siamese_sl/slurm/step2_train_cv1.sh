...
#SBATCH --output=slurm/logs/step2_CV1_%j.out
#SBATCH --error=slurm/logs/step2_CV1_%j.err

# Exit on error
set -e

echo "=================================================="
echo "Siamese SL Training: CV1 (Edge-based)"
echo "=================================================="
...
echo "=================================================="
echo "CV1 Training completed at: $(date)"
echo "Results saved to: results/cv1/"
echo "=================================================="
