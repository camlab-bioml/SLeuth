...
mkdir -p ../outputs_Adamson/case_study_without_ESM
...
$PYTHON_PATH case_study.py \
	...
	--hidden2 256 \
	--dropout 0.2 \
	--output_dir ../outputs_Adamson/case_study_without_ESM

echo "=================================================="
echo "Case study completed at: $(date)"
echo "Results saved to: ../outputs_Adamson/case_study_without_ESM/"
echo "=================================================="
