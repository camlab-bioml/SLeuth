#!/bin/bash
#SBATCH --job-name=slmgae_adamson_CV2
...
mkdir -p ../logs
mkdir -p ../outputs_Adamson/CV2
mkdir -p ../outputs_Adamson/CV2/checkpoints
mkdir -p ../outputs_Adamson/CV2/predictions
...
echo "  - Output dir: ../outputs_Adamson/CV2"
...
$PYTHON_PATH train_slmgae.py \
	...
	--pos_neg_ratio 1 \
	--seed 123 \
	--output_dir ../outputs_Adamson/CV2
...
for fold in 0 1 2 3 4; do
	PRED_FILE="../outputs_Adamson/CV2/fold_${fold}_cv2_predictions.csv"
	if [ -f "$PRED_FILE" ]; then
...
echo "Results saved to: ../outputs_Adamson/CV2/"
echo "=================================================="
